				...
				<nav>
					<div class="contentUserData">
						<div class="divPhofileImage">
							<img src="../user/pictures/phofiles/<?php echo $Fotografia ?>" alt="<?php echo $Nombre ?>">
						</div>
						<div class="complete-data-user animated fadeIn">
							...
							<div class="options-buttons-user">
								...
								<a href="../documents/Terminos y condiciones.pdf" target="_blank"><div class="content-min-title">
									Terminos y condiciones
								</div></a>
								<div class="content-min-title">
									Configuración
								</div>
								<a href="../user/phpfiles/log-out.php"><div class="content-min-title">
									Salir
								</div></a>
							</div>
						</div>
